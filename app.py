"""
Controller Terminal v5.0 — FULLY LIVE
Economic Calendar: Finnhub (live)
Forex Prices + Currency Strength: Twelve Data (live)
COT: CFTC Public API (live)
Setup Engine: ICT MMXM Rule-Based (free)
"""
